...
#Software Design Project Fall 2012
#Menu.py
#The following code has been downloaded and altered for personal use
...
class Menu:
    ...
    pola = []
    rozmiar_fontu = 32
    font_path = 'menu_data/coders_crux/coders_crux.ttf'
...
if __name__ == "__main__":
    import sys
    surface = pygame.display.set_mode((700,700)) #0,6671875 and 0,(6) of HD resoultion
    ...
    *get_postion will return actual position of seletion. '''
    ...
    menu.init(['New Game','Continue', 'Leaderboard','Quit'], surface)#necessary
